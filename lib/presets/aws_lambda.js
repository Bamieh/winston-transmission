import SentryLogger from '../transports/sentry';
import _ from 'lodash';

export default function (logger, event, context, customContext = {}) {
  const sentryLogger = _.head(_.filter(logger.transports, e => e.name === 'sentryLogger'));
